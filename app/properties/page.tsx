  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 pt-24">
        <div className="mb-8">
          <h1 className="text-4xl font-serif font-bold text-[#D4AF37] mb-4">{t("properties.title")}</h1>
          <p className="text-gray-400 mb-6">{t("properties.description")}</p>

          <PropertySearchBar onFilterChange={handleFilterChange} />
            ...
            <div className="flex items-center justify-between">
              <p className="text-gray-400">
                {t("properties.showing")
                  ...
                  .replace("{total}", String(mockProperties.length))}
              </p>
              <div className="flex items-center gap-2">
                <label className="text-gray-400 text-sm">{t("properties.itemsPerPage")}</label>
                <select
                  value={itemsPerPage}
                  onChange={(e) => {
        ...
        {!user && (
          <div className="text-center mt-12 p-8 border border-[#D4AF37]/20 rounded-lg bg-[#1F1F1F]">
            ...
            <p className="text-gray-400 mb-6">Register now to access our complete portfolio of luxury properties.</p>
            <button
